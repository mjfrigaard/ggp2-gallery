...
The `divider` argument let's us control the spine partitions (vertically and horizontally). 
:::


::: {style="font-size: 0.75em;"}
```{r}
#| label: comapre_mosaic_show
#| eval: false
#| echo: true
#| warning: false
#| message: false
...
::: {style="font-size: 0.85em;"}
Below are the two vertical orientation options for the `divider` argument. 
:::
