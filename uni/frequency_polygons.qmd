...
Frequency polygons are similar to histograms, but they use lines instead of bars to represent the variable distribution. The height of the line represents the frequency (or count) of the value occurrence.
