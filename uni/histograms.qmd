...
Histograms use bars, but they are a special kind of bar-graph. The `x` axis is divided into ‘bins’ that cover the range of the variable values, and the height of the bars is the frequency (or count) of the value occurrence (on the `y` axis).
