...
::: {style="font-size: 0.90em; color: #38B44A;"}
`r emo::ji("check")` a categorical variable (i.e., with non-numeric value levels)
:::
...
In `ggplot2`, bar charts can be built using `geom_bar()` (see also: [`geom_col()`](https://mjfrigaard.github.io/ggp2-gallery/geoms/geom_col.html)).
